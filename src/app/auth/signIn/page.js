...
//               throw new Error('This API endpoint doesnt support POST requests. Check the API documentation for the correct endpoint.');
//             }
...
//           // Only attempt to parse JSON if we got a successful response
...
//           } else {
//             console.log('Login successful, but response was not JSON');
//             reset(); // Clear form on success
//           }
//         } catch (error) {
